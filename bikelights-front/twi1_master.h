...
#ifndef TWI1_MASTER_H
#define TWI1_MASTER_H
...
/*lint ++flb "Enter library region" */
#define TWI1_SCL_HIGH()   do { NRF_GPIO->OUTSET = (1UL << TWI1_MASTER_CONFIG_CLOCK_PIN_NUMBER); } while(0)   /*!< Pulls SCL line high */
#define TWI1_SCL_LOW()    do { NRF_GPIO->OUTCLR = (1UL << TWI1_MASTER_CONFIG_CLOCK_PIN_NUMBER); } while(0)   /*!< Pulls SCL line low  */
#define TWI1_SDA_HIGH()   do { NRF_GPIO->OUTSET = (1UL << TWI1_MASTER_CONFIG_DATA_PIN_NUMBER);  } while(0)   /*!< Pulls SDA line high */
#define TWI1_SDA_LOW()    do { NRF_GPIO->OUTCLR = (1UL << TWI1_MASTER_CONFIG_DATA_PIN_NUMBER);  } while(0)   /*!< Pulls SDA line low  */
#define TWI1_SDA_INPUT()  do { NRF_GPIO->DIRCLR = (1UL << TWI1_MASTER_CONFIG_DATA_PIN_NUMBER);  } while(0)   /*!< Configures SDA pin as input  */
#define TWI1_SDA_OUTPUT() do { NRF_GPIO->DIRSET = (1UL << TWI1_MASTER_CONFIG_DATA_PIN_NUMBER);  } while(0)   /*!< Configures SDA pin as output */
#define TWI1_SCL_OUTPUT() do { NRF_GPIO->DIRSET = (1UL << TWI1_MASTER_CONFIG_CLOCK_PIN_NUMBER); } while(0)   /*!< Configures SCL pin as output */
/*lint -restore */

#define TWI1_SDA_READ() ((NRF_GPIO->IN >> TWI1_MASTER_CONFIG_DATA_PIN_NUMBER) & 0x1UL)                     /*!< Reads current state of SDA */
#define TWI1_SCL_READ() ((NRF_GPIO->IN >> TWI1_MASTER_CONFIG_CLOCK_PIN_NUMBER) & 0x1UL)                    /*!< Reads current state of SCL */
